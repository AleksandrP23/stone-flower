...
/* harmony import */ var _node_modules_fslightbox_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../node_modules/fslightbox/index.js */ "./node_modules/fslightbox/index.js");
/* harmony import */ var _node_modules_fslightbox_index_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_node_modules_fslightbox_index_js__WEBPACK_IMPORTED_MODULE_2__);
...
// let center = [56.34105599356019, 43.817078808528905];
var center = [56.34100750797671, 43.81700269503323];
...
function init() {
  ...
  var placemark1 = new ymaps.Placemark(center, {
    balloonContent: "\n\n    <div class=\"balloon\">\n      <h4 class=\"balloon__title\">\u041A\u043E\u043D\u0442\u0430\u043A\u0442\u044B</h4>\n      <ul class=\" list-reset balloon__list\">\n        <li class=\"balloon__item-tel\">\n          <a class=\"balloon__link\" href=\"tel:+79506165757\">+7 950 616-57-57</a>\n        </li>\n        <li class=\"balloon__item-mail\">\n          <a class=\"balloon__link\" href=\"mailto:plitkaikamen-nn@yandex.ru\">plitkaikamen-nn@yandex.ru</a>\n        </li>\n        <li class=\"balloon__item-address\">\n          <address class=\"balloon__item-street\">\u0433. \u041D\u0438\u0436\u043D\u0438\u0439 \u041D\u043E\u0432\u0433\u043E\u0440\u043E\u0434, \u0443\u043B. \u0424\u0435\u0434\u043E\u0441\u0435\u0435\u043D\u043A\u043E, 45</address>\n        </li>\n        <li class=\"balloon__item-time\">\n          <p class=\"balloon__item-time-text\">\u041F\u043D-\u041F\u0442: c 9:00\u201320:00,</p>\n          <p class=\"balloon__item-time-text\">\u0421\u0431-\u0412\u0441: 10:00\u201318:00</p>\n        </li>\n      </ul>\n\t\t</div>\n\n    "
  }, {
    iconLayout: 'default#image',
    iconImageSize: [60, 60],
    iconImageOffset: [-19, -44]
...
if (product) {
  var items = product.querySelectorAll(".option-checkbox");
  ...
  function clickHandler() {
    ...
    if (countD <= items.length || countD >= items.length) {
  ...
  var itemsCh = product.querySelectorAll(".product-checkbox");
  var buttonCh = product.querySelector("#button-checkbox");
  ...
  window.addEventListener("resize", onResizeCh);
  buttonCh.addEventListener("click", clickHandlerCh);
  var countDCh = onResizeCh();

  function clickHandlerCh() {
    if (window.innerWidth <= 576) {
      countDCh += 3;
    }
    ...
    if (countDCh <= itemsCh.length || countDCh >= itemsCh.length) {
      for (var i = 0; i < countDCh; i++) {
        if (i !== itemsCh.length) {
          itemsCh[i].style.display = "block";
        } else {
          return buttonCh.style.display = "none";
        }
      }
    }
  }
...
var swipersNew = document.querySelector('.new__content');
var swipersPost = document.querySelector('.post__content');
var swipersGal = document.querySelector('.gallery__content');

if (swipersNew) {
  var swiperNew = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](swipersNew, {
    slidesPerView: 4,
    spaceBetween: 40,
    navigation: {
      nextEl: '.new__slider-btn--next',
      prevEl: '.new__slider-btn--prev'
    },
    pagination: {
      el: '.new__pagination',
      type: 'bullets',
...
if (swipersPost) {
  var swiperPost = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](swipersPost, {
    slidesPerView: 4,
    spaceBetween: 40,
    navigation: {
      nextEl: '.new__slider-btn--next',
...
if (swipersGal) {
  var swiperGal = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](swipersGal, {
    slidesPerView: 4,
    spaceBetween: 40,
    navigation: {
      nextEl: '.new__slider-btn--next',
